...
const int ApplyInterval = 10 * debugMul;     //	日志应用间隔时长

const int minRandomizedElectionTime = 300 * debugMul;  // ms  最小选举超时时间
const int maxRandomizedElectionTime = 500 * debugMul;  // ms  最大选举超时时间
